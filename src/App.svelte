...
<body>
  <Router url="{url}">
  	<header id="app" class="sticky top-0 shadow-lg lg:px-20 px-6 bg-white flex flex-wrap items-center lg:py-0 py-2">
  		<div class="flex-1 flex justify-between items-center">
        <a href="#">
          <Link to="/" >
    				<svg width="225.129" height="36.101" viewBox="0 0 449 72">
    				<defs>
    					<style>.cls-1 {
    						font-size: 100px;
    						fill: #ff4040;
    				...
    				<text id="Watashi" class="cls-1" x="223" y="68.528">
    					<tspan x="223">Watashi</tspan>
    				</text>
    				</svg>
    			</Link>
        </a>
